...
###
 ...
 # @LastEditTime: 2022-03-13 06:24:34
### 

DATA_DIR_ROOT=$1

FILE_NAME=corpus.fa.500.frag.3mer
...
split -d -a 8 -l ${FILE_SIZE} ${DATA_DIR_ROOT}/${FILE_NAME} ${DATA_DIR_ROOT}${SUB_DIR}/bs_${BATCH_SIZE}sl_${seq_len}/${FILE_NAME}.part
echo "切割完毕！"
